...
const rotationStudents = [
  ...
  { name: "Syd Sattler", title: "Rotation Student (GS), Winter 2022" },
  ...
  { name: "Will DeWitt", title: "Rotation Student (GS), Fall 2017" },
  ...
  { name: "Ian Smith", title: "Rotation Student (GS), 2017" },
  ...
  { name: "Jost Burton", title: "Rotation Student (GS), Winter 2011" },
  ...
  { name: "Jarret Egerston", title: "Rotation Student (GS), Winter 2009" },
